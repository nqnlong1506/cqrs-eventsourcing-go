...
type ComplexityRoot struct {
	...
	Mutation struct {
		Borrow     func(childComplexity int, input model.NewBorrow) int
...
type MutationResolver interface {
	...
	Borrow(ctx context.Context, input model.NewBorrow) (*model.Transaction, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.borrow":
		if e.complexity.Mutation.Borrow == nil {
			break
		}

		args, err := ec.field_Mutation_borrow_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Mutation.Borrow(childComplexity, args["input"].(model.NewBorrow)), true
	...
	case "Transaction.book":
		if e.complexity.Transaction.Book == nil {
			break
		}

		return e.complexity.Transaction.Book(childComplexity), true
...
func (ec *executionContext) field_Mutation_borrow_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
...
func (ec *executionContext) _Mutation_borrow(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Mutation_borrow(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().Borrow(rctx, fc.Args["input"].(model.NewBorrow))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_Mutation_borrow(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			...
			case "book":
				return ec.fieldContext_Transaction_book(ctx, field)
			}
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Mutation_borrow_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) _Transaction_book(ctx context.Context, field graphql.CollectedField, obj *model.Transaction) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Transaction_book(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) unmarshalInputNewBook(ctx context.Context, obj interface{}) (model.NewBook, error) {
	...
	fieldsInOrder := [...]string{"title", "genre", "author"}
...
func (ec *executionContext) unmarshalInputnewBorrow(ctx context.Context, obj interface{}) (model.NewBorrow, error) {
	var it model.NewBorrow
	asMap := map[string]interface{}{}
	for k, v := range obj.(map[string]interface{}) {
		asMap[k] = v
	}

	fieldsInOrder := [...]string{"bookID", "userID"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) _Mutation(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "borrow":
			out.Values[i] = ec.OperationContext.RootResolverMiddleware(innerCtx, func(ctx context.Context) (res graphql.Marshaler) {
				return ec._Mutation_borrow(ctx, field)
			})
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
...
func (ec *executionContext) _Transaction(ctx context.Context, sel ast.SelectionSet, obj *model.Transaction) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "book":
			out.Values[i] = ec._Transaction_book(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		default:
